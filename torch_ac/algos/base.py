...
import torch
from torch_ac.ac_format import default_preprocess_obss
from torch_ac.ac_utils import DictList, ParallelEnv


class BaseAlgo(ABC):

    """The base class for RL algorithms. Logging added for RL Sandbox """

    def __init__(self, envs, acmodel, log_dir, device, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
        ...
        acmodel : torch.Module
            the model
        log_dir:  where to write logs on the file system
        ...
        self.env = ParallelEnv(envs, log_dir)
